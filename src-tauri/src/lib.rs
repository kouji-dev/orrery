...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            projects::commands::project_tree,
            projects::commands::project_dir,
            ...
            agents::commands::agent_commits_files,
            agents::commands::agent_commits_file_diff,
            ...
            git::branches::project_branch_update,

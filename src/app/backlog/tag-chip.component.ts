...
@Component({
  ...
  template: `
    ...
    <span
      ...
      style="display:inline-flex;align-items:center;gap:4px;flex:none;max-width:170px;font-family:var(--font-mono);font-size:10.5px;line-height:1;letter-spacing:0.01em;border-radius:999px;white-space:nowrap;user-select:none;transition:background .12s,border-color .12s,color .12s"
    >
      ...
      @if (removable()) {
        <button
          ...
          style="display:grid;place-items:center;border:none;background:transparent;cursor:pointer;color:var(--ink-4);padding:0;width:14px;height:14px;border-radius:4px;flex:none"
        >
